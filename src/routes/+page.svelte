...
<div class="container mx-auto px-6 py-12">
	...
	<div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
		...
		<a
			href="/speaking"
			class="bg-gray-800 rounded-lg border border-gray-700 p-6 shadow-md transition-all transform hover:scale-103 hover:border-green-600"
		>
		...
		<a
			href="/writing"
			class="bg-gray-800 rounded-lg border border-gray-700 p-6 shadow-md transition-all transform hover:scale-103 hover:border-blue-600"
				>
		...
		<a
			href="/reading"
			class="bg-gray-800 rounded-lg border border-gray-700 p-6 shadow-md transition-all transform hover:scale-103 hover:border-purple-600"
				>
		...
		<a
			href="/listening"
			class="bg-gray-800 rounded-lg border border-gray-700 p-6 shadow-md transition-all transform hover:scale-103 hover:border-orange-600"
				>
