...
<div class="container mx-auto max-w-4xl px-6 py-12">
        ...
        <div class="mb-12 text-center">
                  <h1 class="text-3xl font-black text-white mb-8 inline-block px-10 py-3 rounded-xl bg-gradient-to-r from-cyan-500 via-teal-500 to-cyan-600 shadow-xl shadow-cyan-500/30 border-2 border-blue-600/80">
        ...
        <!-- CTA CARD -->
        <div class="mb-2 max-w-2xl mx-auto mt-12">
                <div class="relative border-blue-500 from-blue-950/70 to-blue-900/70 bg-gradient-to-br border-2 rounded-xl p-8 pt-12 shadow-lg">
                        ...
                        <div class="absolute top-8 right-6 opacity-70 md:opacity-90">
