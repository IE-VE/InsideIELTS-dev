...
<div class="container mx-auto max-w-4xl px-6 py-12">
        ...
        <div class="mb-12 text-center">
                <h1 class="text-3xl font-black text-gray-900 mb-8 inline-block px-8 py-3 rounded-xl bg-gradient-to-r from-cyan-600 via-teal-600 to-cyan-700 shadow-xl shadow-cyan-500/30 border-2 border-cyan-400/50">
