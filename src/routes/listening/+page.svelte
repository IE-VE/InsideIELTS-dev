	...
	<div class="container mx-auto max-w-6xl px-6 py-8">
		...
		<!-- CTA CARD -->
			<div class="mb-12 max-w-3xl mx-auto">
				<div class="relative border-amber-800 from-amber-950/30 to-amber-900/20 bg-gradient-to-br border-2 rounded-xl p-8 pt-12 shadow-lg">
					<!-- Top accent bar matching notebook variant -->
					<div class="absolute top-0 left-0 h-4 w-full rounded-t-xl bg-gradient-to-r from-amber-500 to-yellow-400"></div>
