			...
			<div class="space-y-6">
				...
				<div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
					<div class="flex items-start gap-4">
						...
						<a href="#" class="text-teal-600 dark:text-teal-400 hover:underline font-semibold">
							IELTS Test Overview
						</a>
					</div>
				</div>
						...
						<div class="ml-12">
							...
							<div class="space-y-2 ml-8">
								<div class="flex gap-2">
									...
									<a href="#" class="text-teal-600 dark:text-teal-400 hover:underline">Multiple choice</a>
								</div>
								<div class="flex gap-2">
									<span class="text-gray-600 dark:text-gray-400">(ii)</span>
									<a href="#" class="text-teal-600 dark:text-teal-400 hover:underline">Short answer</a>
								</div>
								<div class="flex gap-2">
									<span class="text-gray-600 dark:text-gray-400">(iii)</span>
									<a href="#" class="text-teal-600 dark:text-teal-400 hover:underline">Sentence completion</a>
								</div>
							</div>
						</div>
					</div>
