...
<div class="min-h-screen bg-gray-900 text-white">
	...
	<div style="max-width: 1200px;" class="mx-auto px-6 py-8">
		...
		<section class="bg-gray-800 rounded-lg p-8 shadow-sm border border-gray-700 mb-8">
			<div class="text-center">
				...
				<!-- Results Display -->
				{#if showResults}
					<div class="bg-gray-700 rounded-lg p-6 mt-6 border border-gray-600">
						...
						<!-- Exercise 1 Results -->
						<div class="mb-6">
							<h5 class="text-lg font-bold text-white mb-3">Exercise 1 (Q11-Q15)</h5>
						...
						<!-- Exercise 2 Results -->
						<div>
							<h5 class="text-lg font-bold text-white mb-3">Exercise 2 (Q21-Q25)</h5>
							<div class="space-y-2 text-sm">
