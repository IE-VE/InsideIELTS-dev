		...
		<div class="container mx-auto px-6 py-6">
			<div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
				<div class="text-center lg:text-left">
					<div class="text-sm text-teal-400 font-medium mb-2">LESSON CODE: IE2401_01.2</div>
					<div class="text-sm text-gray-400 mb-1">01 (ii)</div>
					<h1 class="text-3xl font-bold text-white mb-2">Skills Practice</h1>
					<p class="text-gray-400 italic">(60 mins)</p>
				</div>
				<a
					href="/IETPP"
		...
		<section class="bg-teal-600/20 rounded-lg p-8 shadow-sm border border-teal-600/50 mb-8">
			...
			<div class="max-w-4xl mx-auto">
				...
				<div class="text-center">
					...
					<a
						href="/IETPP/lesson-01/short-answer/skill-check"
