...
<div class="min-h-screen bg-gray-900 text-white">
        ...
        <div style="max-width: 1200px;" class="mx-auto px-3 md:px-6 py-12">
                ...
                <section class="bg-blue-600/20 rounded-lg p-6 md:p-10 shadow-sm border border-blue-600/50 mb-12">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 md:p-8 shadow-sm border border-gray-200 dark:border-gray-700 mb-12 text-gray-900 dark:text-gray-100" style="max-width: 900px; margin: 0 auto;">
