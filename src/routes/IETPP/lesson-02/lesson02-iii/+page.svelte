...
<div class="min-h-screen bg-gray-900 text-white">
        ...
        <!-- Page Content -->
 <div style="max-width: 1200px;" class="mx-auto px-3 md:px-6 py-8">                                                                                               <!-- Lesson Title Section -->                                             <section class="bg-cyan-800/25 rounded-lg p-4 md:p-10 shadow-sm border border-cyan-600 mb-12">                                                              <div class="flex items-center justify-center gap-4 mb-10">                                                                                      <div class="text-4xl">📖</div>                                                 <h2 class="text-3xl font-bold text-center text-white tracking-wide">Summary Completion</h2>                                                                     <div class="text-4xl">📖</div>                                                </div>                                                                                                            <!-- Educational Section -->                                                                               <div class="bg-gray-800 rounded-lg p-4 md:p-8 shadow-sm border border-gray-600 mb-12">
