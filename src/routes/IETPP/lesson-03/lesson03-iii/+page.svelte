...
<svelte:head>
	<title>Writing - Lexical Resource | InsideIELTS Test Preparation Program</title>
...
<div class="min-h-screen bg-gray-900 text-white">
	...
	<div class="max-w-5xl container mx-auto px-3 md:px-6 py-8">
		<div class="bg-gray-50 dark:bg-gray-800 rounded-lg px-6 py-2 mb-8">
			<div class="text-center">
				...
				<p class="text-sm text-gray-400 mb-4">03 (iii) • Skills Practice • (60 mins)</p>
			</div>
	...
	<div style="max-width: 1200px;" class="mx-auto px-3 md:px-6 py-8">
		...
		<section class="bg-teal-100 dark:bg-teal-900 rounded-lg p-4 md:p-8 shadow-sm border border-blue-600 mb-8">
		...
		<section class="text-center py-8">
			<div class="bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-700">
				<p class="text-white mb-6">End of Lesson 03 (iii)</p>
				<a
					href="/IETPP#lesson-03"
