...
<svelte:head>
	<title>Writing - Grammatical Range & Accuracy | InsideIELTS Test Preparation Program</title>
	...
	<div class="max-w-5xl container mx-auto px-3 md:px-6 py-8">
		<div class="bg-gray-50 dark:bg-gray-800 rounded-lg px-6 py-2 mb-8">
			<div class="text-center">
				...
				<p class="text-sm text-gray-400 mb-4">03 (iv) • Skills Practice • (60 mins)</p>
			</div>
	...
	<div style="max-width: 1200px;" class="mx-auto px-3 md:px-6 py-8">
			...
			<div class="max-w-6xl mx-auto">
				<div class="bg-gray-800 rounded-lg p-6 text-lg border border-gray-700 mb-8">
					...
					<p class="text-white mb-8">
						<strong>Grammatical Range & Accuracy</strong> rates the variety, complexity and accuracy of the sentence structures, tenses and word
						forms you use in your writing responses.
					</p>
		...
		<section class="text-center py-8">
			<div class="bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-700">
				<p class="text-white mb-6">End of Lesson 03 (iv)</p>
				<a
					href="/IETPP#lesson-03"
